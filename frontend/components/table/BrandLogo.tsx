...
export const BrandLogo: React.FC<BrandLogoProps> = ({ onClick }) => {
  return (
    <div className="flex items-center gap-2.5 cursor-pointer select-none" onClick={onClick}>
      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl overflow-hidden border border-[#E2E8F0] dark:border-[#222732] shadow-xs bg-[#FFFFFF] dark:bg-[#181B21] flex items-center justify-center flex-shrink-0">
        <img
      ...
      <div>
        <h1 className="text-base sm:text-lg font-[800] text-[#000000] dark:text-[#FFFFFF] tracking-tight leading-none font-heading">
          Kohi
        </h1>
