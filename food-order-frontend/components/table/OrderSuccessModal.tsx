      ...
      {isOrderSuccessModalOpen && latestCreatedOrder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-[#FFFFFF] dark:bg-[#181B21] border border-[#E2E8F0] dark:border-[#222732] rounded-2xl shadow-2xl z-10 overflow-hidden"
          >
            {/* Top accent bar */}
            ...
            <div className="p-7 flex flex-col gap-5 text-center">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <button
                  onClick={() => setIsOrderSuccessModalOpen(false)}
                  className="w-full py-3 bg-transparent border border-[#E2E8F0] dark:border-[#222732] text-[#64748B] dark:text-[#9CA3AF] hover:text-[#3AA6FF] dark:hover:text-[#5B9EFF] hover:border-[#3AA6FF]/40 dark:hover:border-[#5B9EFF]/40 rounded-xl text-[13px] font-[500] transition-all"
                >
                  Chọn thêm món khác
                </button>
              </div>
