...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-2xl border border-[#E2E8F0] dark:border-[#222732] bg-[#FFFFFF] dark:bg-[#11141A] p-5 sm:p-6 text-sm text-[var(--text-primary)] shadow-xl transition-all font-sans",
        className
      )}
      {...props}
    />
