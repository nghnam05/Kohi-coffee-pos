          ...
          <div className="bg-slate-50/90 dark:bg-slate-900/80 rounded-[15px] p-3.5 backdrop-blur-md relative overflow-hidden border border-slate-200/80 dark:border-white/5">
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <h4 className="text-[12.5px] font-bold text-slate-900 dark:text-white leading-tight font-sans tracking-tight">
                      Kohi AI Assistant
                    </h4>
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping" />
                  </div>
                  <p className="text-[10px] font-medium text-slate-500 dark:text-slate-400 font-sans mt-0.5">
              ...
              <button
                ...
                className="px-2 py-1 rounded-lg bg-blue-500/15 text-blue-600 dark:text-blue-400 border border-blue-500/30 text-[10px] font-bold hover:bg-blue-600 hover:text-white transition-all font-sans cursor-pointer active:scale-95 flex items-center gap-1"
