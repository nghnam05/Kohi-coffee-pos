...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "relative inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2 text-xs font-medium data-active:font-semibold uppercase tracking-wider text-[var(--text-secondary)] transition-all cursor-pointer select-none outline-none hover:text-[var(--text-primary)] data-active:bg-[#3AA6FF] data-active:text-white data-active:shadow-md data-active:shadow-[#3AA6FF]/20 disabled:pointer-events-none disabled:opacity-50 font-sans",
        className
      )}
      {...props}
    />
